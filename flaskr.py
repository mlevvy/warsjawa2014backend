...
def confirm_user(user_email):
    ...
    return """<!DOCTYPE html>
    <html><head lang="en"><link href="//maxcdn.bootstrapcdn.com/bootstrap/3.2.0/css/bootstrap.min.css" rel="stylesheet"><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no"><title>Warsjawa: 100% workshop formula | Confirmation</title><meta name="description" content="Conference for developers, by developers. Unique 100% workshop formula. “Learn by doing” approach. Proudly host workshops related to all aspects of software development: designing, developing, testing, maintaining etc. Initially oriented around Java and JVM programming languages. Now open to other programming languages like Scala, Groovy, Python, mobile development for Android, iOS and others."><link rel="stylesheet" href="http://warsjawa.pl/stylesheets/warsjawa.css"><link rel="shortcut icon" href="http://warsjawa.pl/images/favicons/favicon.ico"><link rel="apple-touch-icon" sizes="57x57" href="http://warsjawa.pl/images/favicons/apple-touch-icon-57x57.png"><link rel="apple-touch-icon" sizes="114x114" href="http://warsjawa.pl/images/favicons/apple-touch-icon-114x114.png"><link rel="apple-touch-icon" sizes="72x72" href="http://warsjawa.pl/images/favicons/apple-touch-icon-72x72.png"><link rel="apple-touch-icon" sizes="144x144" href="http://warsjawa.pl/images/favicons/apple-touch-icon-144x144.png"><link rel="apple-touch-icon" sizes="60x60" href="http://warsjawa.pl/images/favicons/apple-touch-icon-60x60.png"><link rel="apple-touch-icon" sizes="120x120" href="http://warsjawa.pl/images/favicons/apple-touch-icon-120x120.png"><link rel="apple-touch-icon" sizes="76x76" href="http://warsjawa.pl/images/favicons/apple-touch-icon-76x76.png"><link rel="apple-touch-icon" sizes="152x152" href="http://warsjawa.pl/images/favicons/apple-touch-icon-152x152.png"><link rel="icon" type="image/png" href="http://warsjawa.pl/images/favicons/favicon-196x196.png" sizes="196x196"><link rel="icon" type="image/png" href="http://warsjawa.pl/images/favicons/favicon-160x160.png" sizes="160x160"><link rel="icon" type="image/png" href="http://warsjawa.pl/images/favicons/favicon-96x96.png" sizes="96x96"><link rel="icon" type="image/png" href="http://warsjawa.pl/images/favicons/favicon-16x16.png" sizes="16x16"><link rel="icon" type="image/png" href="http://warsjawa.pl/images/favicons/favicon-32x32.png" sizes="32x32"><meta name="msapplication-TileColor" content="#1b4055"><meta name="msapplication-TileImage" content="http://warsjawa.pl/images/favicons/mstile-144x144.png"><meta name="msapplication-config" content="http://warsjawa.pl/images/favicons/browserconfig.xml"></head>
    <body><section id="header"><div class="row"><div class="small-12 columns text-center"><h1><span class="dot">·</span>WARS<br>JAWA<span class="dot">·</span></h1></div></div><div class="row"><div class="small-12 columns text-center"><hr></div></div><div class="row"><div class="small-12 columns text-center"><h3>100% WORKSHOP FORMULA</h3></div></div><div class="row"><div class="small-12 columns text-center"><img alt="Warsjawa logo" src="http://warsjawa.pl/images/warsjawa-logo-200x328.png"></div></div></section>
    <center><h3>You are fully confirmed now.</h3></center>Your workshops:
    <div class="list-group">""" + ''.join(['<a href="http://registration.warsjawa.pl/" class="list-group-item">' + w['name'] + '</a>' for w in workshops]) + '</div></body></html>'
